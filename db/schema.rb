...
ActiveRecord::Schema.define(version: 20170929110315) do
  ...
  create_table "application_candidates", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_application_candidates_on_user_id"
  end
  ...
  create_table "categories", force: :cascade do |t|
    ...
    t.integer "application_categories_count", default: 0
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.index ["user_id", "rating_id"], name: "index_reviews_on_user_id_and_rating_id", unique: true
  ...
  add_foreign_key "application_candidates", "users", on_delete: :nullify
  ...
  add_foreign_key "reviews", "ratings", on_delete: :cascade
